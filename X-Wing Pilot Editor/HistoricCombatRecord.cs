...
namespace X_Wing_Pilot_Editor
{
    ...
    {
        public HistoricMissionType MissionType { get; set; }
        public List<bool> MissionComplete { get; set; }
        public List<uint> MissionScore { get; set; }

        public HistoricCombatRecord(HistoricMissionType missionType, int numberOfMissions)
        {
        ...
        public HistoricCombatRecord(HistoricMissionType missionType, byte[] bytes, int numberOfMissions, int missionCompletedOffset, int missionScoreOffset)
        {
            MissionType = missionType;
            MissionComplete = new List<bool>(numberOfMissions);
            MissionScore = new List<uint>(numberOfMissions);
